...
export const validatePasswordInit = (password: string): boolean => {
...
export const defaulSecurityParameters: SecurityParameters[] = [
    { id: -1, namerule: '', valor: '' }, { id: -1, namerule: '', valor: '' },  { id: -1, namerule: '', valor: '' },
    { id: -1, namerule: '', valor: '' }, { id: -1, namerule: '', valor: '' },  { id: -1, namerule: '', valor: '' },
    { id: -1, namerule: '', valor: '' }, { id: -1, namerule: '', valor: '' },  { id: -1, namerule: '', valor: '' },
];
